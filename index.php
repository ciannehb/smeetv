...
<div id="controller" class="default draggable-handle ">
 ...
 <div class="dragginggniggard"><div class="draggable-handle ui-icon">&nbsp;</div></div>
    ...
    Use <span class="attn" rel="prev2">&#8592;</span> and <span rel="next2" class="attn">&#8594;</span> to navigate back and forth, <span class="btn" style="font-size:.75em;float:none;line-height:1em;margin-right:0">SPACEBAR</span> to pause/resume the presentati
on, <span class="attn" rel="yakor">resize</span> and <span rel="draggable-handle" class="attn">move</span> the tv around. Check out <span class="attn" rel="gotosettings">Settings</span>.
    </div></div>
    </div>
...
<script src="http://fsdn3.somewhe.com/smeetv/js/jquery.ui.core.js"></script>
<script src="http://fsdn3.somewhe.com/smeetv/js/jquery.ui.widget.js"></script>
<script src="http://fsdn3.somewhe.com/smeetv/js/jquery.ui.mouse.js"></script>
<script src="http://fsdn3.somewhe.com/smeetv/js/jquery.ui.draggable.js"></script>
<script src="http://fsdn3.somewhe.com/smeetv/js/jquery.ui.resizable.js"></script>
<script src="http://fsdn3.somewhe.com/smeetv/js/jquery.ui.tabs.js"></script>
<script src="/js/smeetv.js/smeetv.js"></script>

    <script type="text/javascript" src="http://fsdn3.somewhe.com/smeetv/js/jquery.cycle.all.2.72.js"></script>
