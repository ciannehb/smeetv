...
#sleep 60;  curl http://smeetv.com/etc/util/index.keyword.php?priority=7 > /dev/null
#sleep 70;  curl http://smeetv.com/etc/util/index.keyword.php?priority=8 > /dev/null
#sleep 80;  curl http://smeetv.com/etc/util/index.keyword.php?priority=9 > /dev/null
#sleep 90;  curl http://smeetv.com/etc/util/index.keyword.php?priority=10 > /dev/null
