...
echo "
<html><head><style>body {margin:0;padding:0;}html{overflow:hidden;}article {position:relative;overflow:hidden;height:110px;}img {width:100%;cursor:pointer;
...
}.description a{display:inline-block;position:absolute;top:.25em;left:.25em;text-decoration:none;color:rgba(255,255,255,.1);
    letter-spacing: -1px;
    line-height: 0.75em;
    margin: 0;
    text-align: left;
