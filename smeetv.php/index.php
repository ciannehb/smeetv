...
$feed[]='http://search.twitter.com/search.rss?lang=en&q=flickr.com';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=plixi.com';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=movapic.com';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=img.ly';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=upic.me';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=fotki.yandex.ru';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=imgur.com';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=lockerz.com';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=picplz.com';



//$feed[]='http://search.twitter.com/search.rss?lang=en&q=twitvid';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=youtube.com/watch';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=youtu.be';
$feed[]='http://search.twitter.com/search.rss?lang=en&q=vimeo.';
...
foreach ($doc->getElementsByTagName('item') as $node) {
    ...
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"flickr.com") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"plixi.com") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"movapic.com") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"img.ly") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"upic.me") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"fotki.yandex.ru") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"imgur.com") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"lockerz.com") === false ||
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"picplz.com") === false ||
    ...
    !strpos($node->getElementsByTagName('title')->item(0)->nodeValue,"vimeo") === false
    ){
        $insert = 1;
    } else {
        $insert = false;
...
<html lang="en">
<head>
<meta http-equiv="refresh" content="24;url=http://fs.f1vlad.com/smeetv/smeetv.php/">
