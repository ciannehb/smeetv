...
gotosrc('/smeetv/smeetv/tv/img/'+findid);
e.preventDefault();
});
...
/* !!!
bug, below (a.indexOf(' ',tmpPosStart);) if there's no space following URL, search fails! NEeed  to fix
*/



/* the thing below need to be converted into function */
...
$('#'+id).load('xdom.php?geturl=' + shorturl + ' ' + noxpath,function(response,status,xhr){
...
*/
    ...
    <div class="busy"><img src="loading.gif"></div>
    <div id="helparrow"><img src="arrow.png"></div>
